...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-400 px-6 py-18 sm:py-20 lg:px-8" >
        <div className='' style={{boxShadow:"14px 14px 14px 14px rgba(0, 0, 0, 0.279)",padding:"1rem"}}>
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contact With Shuru Fitness</h2>
