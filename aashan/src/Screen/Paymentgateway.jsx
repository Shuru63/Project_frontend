            ...
            <div className="col-12">
                <div className="card p-3">
                    <div className="card-body border p-0">
                        ...
                        <div className=" p-3 pt-0" id="">
                            <div className="row">
                                <div className="col-8">
                                    <p className="h4 mb-0">Summary</p>
                                    <p className="mb-0"><span className="fw-bold">Product:</span><span className="c-green">: SubScription</span></p>
                    ...
                    <div className="card-body border p-0">
                        ...
                        <div className=" show p-3 pt-0" id="">
                            <div className="row">
